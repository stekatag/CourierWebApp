...
namespace CourierWebApp.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Unit,Price,Courier,Date")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Unit,Price,Courier,Date")] Delivery delivery)
        {
            if (id != delivery.Id)
            {
                return NotFound();
